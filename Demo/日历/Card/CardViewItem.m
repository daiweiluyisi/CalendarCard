...
//        SELF_STRONG;
//        self.sd_layout.centerXEqualToView(strongSelf.cardView).centerYIs((H(strongSelf) - H(strongSelf.cardView))/2 ).widthIs(self.width).heightIs(self.height);
...
//        SELF_STRONG;
//        self.sd_layout.centerXEqualToView(strongSelf.cardView).centerYIs((rect.size.height - H(strongSelf.cardView)) /2 ).widthIs(rect.size.width).heightIs(rect.size.height);
    }
}
...
//        self.sd_layout.centerXIs(centerX).centerYIs(100).widthIs(self.width).heightIs(self.height);
    }
    else {
        CGRect rect = [self.cardView itemRectAtIndex:index];
...
//        self.sd_layout.centerXIs(centerX).centerYIs(100).widthIs(rect.size.width).heightIs(rect.size.height);
    }
}
